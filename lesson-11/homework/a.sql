...
select*from Customers
select*from Orders
SELECT c.CustomerID, c.FirstName, c.LastName, c.City, o.OrderDate
FROM Customers AS c
...
select*from Orders
select*from Customers
select count (o.Quantity)as totalorders ,c.CustomerID
from Orders as o
join Customers as c on c.CustomerID=o.CustomerID
group by (o.Quantity),c.CustomerID
...
select*from Customers
select*from Orders
select c.FirstName,max(o.OrderDate) as recentorder,o.OrderID
from Customers as c
left join Orders as o on c.CustomerID=o.CustomerID
group by c.FirstName, o.OrderDate,o.OrderID
...
WHERE c.CategoryName = 'Electronics'
   OR (od.Quantity * od.UnitPrice) > 350;
...
from Employees as e
join Departments as d on e.DepartmentID=d.DepartmentID
where d.DepartmentName='HR' or d.DepartmentName='finance' or e.Name='a''e''u''o'
--Return: EmployeeName, DepartmentName, Salary
