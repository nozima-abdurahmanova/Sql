...
SELECT p.ProductName, MAX(s.SalesAmount) AS HighestSale
FROM Products p
JOIN Sales s ON p.ProductID = s.ProductID
GROUP BY p.ProductName;


5. Doubling numbers until < 1,000,000 (recursive CTE):
...
8. Employees with salary above avg salary (CTE):
