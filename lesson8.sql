...
SELECT year, '2012' AS [YearColumn], [2012] AS Population FROM Population_Each_Year
UNION ALL
SELECT year, '2013', [2013] FROM Population_Each_Year;
